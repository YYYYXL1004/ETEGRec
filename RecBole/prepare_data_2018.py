#!/usr/bin/env python3
"""
数据准备脚本 - 从Amazon 2018原始数据生成RecBole .inter文件和ETEGRec所需的train/valid/test.jsonl

功能:
1. 读取Amazon 2018原始JSON数据
2. 数据清洗和过滤 (最少5次交互)
...
def load_and_preprocess(review_file, min_interactions=5):
    """加载并预处理Amazon 2018评论数据"""
    print(f"📖 读取数据: {review_file}")
    
    # 读取JSON (2018版本是一行一个JSON对象，但不是标准JSONL)
    reviews = []
...
def main():
    print("=" * 70)
    print("🎵 数据准备 - Amazon Musical Instruments 2018")
    print("=" * 70)
